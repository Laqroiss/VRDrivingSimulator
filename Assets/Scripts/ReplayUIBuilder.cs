...
public class ReplayUIBuilder : MonoBehaviour
{
    ...
    void BuildPlayerPanel()
    {
        ...
        replaySystem.btnReplayPlay = MakeButton(btnRow, "BtnPlay", "в  Play", colorBtnPlay);
        replaySystem.btnReplayStop = MakeButton(btnRow, "BtnStop", "в  Stop", colorBtnStop);
    ...
    void BuildRecordButton()
    {
        ...
        var lbl = MakeSimpleLabel(go, "вЏє   ", fontSize * 0.85f);
