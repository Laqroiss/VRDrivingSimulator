...
public class ControlLinePlacerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button(_placing
                ? "№Ё Point mode ON  -  Q add  /  Z remove  /  click again to exit"
                : "тя  Enable point placement mode",
            GUILayout.Height(38)))
        {
            _placing = !_placing;
        }
        ...
        if (GUILayout.Button("т  Generate Control Lines", GUILayout.Height(34)))
        {
        ...
        if (GUILayout.Button("т  Clear All", GUILayout.Height(26)))
        {
