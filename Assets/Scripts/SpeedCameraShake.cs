...
/// NOT to the tracked camera itself ‚Äî the XR runtime owns the camera's
/// local transform, so shaking a parent keeps head-tracking intact.
///
/// Typical OpenXR hierarchy:
///   XR Origin
///     ‚‚ Camera Offset  ‚Üê attach here
...
public class SpeedCameraShake : MonoBehaviour
{
    ...
    [SerializeField] private float shakeStartSpeed   = 20f;    // km/h ‚Äî below this: no shake
    [SerializeField] private float shakeMaxSpeed     = 80f;    // km/h ‚Äî full shake above this
